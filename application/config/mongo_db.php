...
$config['mongo_db']['default']['hostname'] = '172.104.181.58';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'dbuser';
$config['mongo_db']['default']['password'] = 'admin123456';
$config['mongo_db']['default']['database'] = 'onlineapp';
...
$config['mongo_db']['test']['username'] = 'sanipc';
$config['mongo_db']['test']['password'] = 'sanipc';
$config['mongo_db']['test']['database'] = 'admin';
