<div class="box">
    ...
    <div class="box-body table-responsive no-padding">
      ...
      <?php for($i=0;$i< count($DataHeading);$i++) { ?>
        ...
        <td><?php if($DataHeading[$i]=='name') { 
                    echo (isset($value['name']))?$value['name'].' ':'';
                    echo (isset($value['firstname']))?$value['firstname'].' ':'';
                    echo (isset($value['lastname']))?$value['lastname'].' ':'';
                  } else { 
                      echo $value[$DataHeading[$i]];
                    } ?>
        </td> <?php } ?>
       <?php  if(isset($ShowAction) && in_array($ShowAction,[1,2,3])) { ?>
       <td> 
        ...
        if($ShowAction==3)
          ...
          <?php } ?>
          <?php if(isset($ActionView) && !empty($ActionView)) {?>
          <a class="btn btn-primary btn-xs" title="View Profile" href="<?php  echo $ActionView.$value['_id']->{'$id'};?>" >
