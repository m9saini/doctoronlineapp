...
//require_once('cimongo/Cimongo_cursor.php');
//require_once(APPPATH . 'libraries/cimongo/Cimongo_extras.php');
/**
	   ...
	   // pr($operation);die;
        if (empty($collection))
	 	...
	 	try
	 	{
	 		...
	 		$documents= $this->db->{$collection}->aggregate($operation, array("cursor" => array("batchSize" => 150)));
	 		$this->_clear();
	 		if ($this->return_as == 'object')
			{
				return (object)$documents;
