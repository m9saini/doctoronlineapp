...
class AtHomeProcess extends REST_Controller
{
                  ...
                  /*  if(isset($params['key_value'])){
                     ...
                     if(isset($params['key_value'])){
                        ...
                        if($params['key_value']==0){
                            ...
                            $c_ids= $this->CommonModel->getCollectionData('patientAppointments',$confirm_wheres, ['_id'=>1], ['created' => -1], 50, $offset);
                            ...
                            $h_ids= $this->CommonModel->getCollectionData('patientAppointments',$home_wheres, ['_id'=>1], ['created' => -1], 50, $offset);
                            $appList=[];
                            ...
                            if(count($appList)>0){
                                ...
                                $wheres['_id']=['$in'=>$ids];
                        $appoinmetsList = $this->CommonModel->getCollectionData('patientAppointments',$wheres, [], ['created' => -1], 50, $offset);
                            }else{
                                $appoinmetsList=[];
                            }
    ...
    public function doctor_list($docIds=array(),$confirm_doctors_ids=array(),$checkValidAppointment=array(),$limit=50,$offset=0){
        $list=[];
